...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used for alert flash messages.
    |
    */
    ...
    'success' => [
        ...
        'consumer-store'          => ':Name fait désormais partie de vos consommateurs !',
        'consumer-update'         => 'Les nouvelles informations de :Name ont bien été prises en compte !',
